...
exports.getEstimateProbability = new commander_1.Command()
    ...
    logger_1.logger.info(`Taking ${sampleSize} samples of a random distribution.`);
    for (let i = 0; i < sampleSize; i++) {
        const { weeks } = await (0, estimate_1.estimate)(records, avgSpeed, possibleHours, devCount);
    ...
    logger_1.logger.info(`Average Estimate in Weeks: ${average}`);
    ...
    logger_1.logger.info(JSON.stringify(percentageOfResults, undefined, 2));
});
